...
class Transaction(models.Model):
    by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL, related_name='by_profile')
    to = models.ForeignKey("BusinessProfile", null=True, on_delete=models.SET_NULL, related_name='to_profile')
